...
concise = PromptSpec(
    key="concise",
    template="""Answer the question concisely using the provided context.
...
Mange brukere kommer til å se meg som en representant for kollektivtrafikkselskapet Ruter.
